package com.ant.ranger.resource;
...
@RestController
public class AntRangerResourceApplication extends ResourceServerConfigurerAdapter{
	...
	public static void main(String[] args) {
		SpringApplication.run(AntRangerResourceApplication.class, args);
	}
	...
	public void configure(HttpSecurity http) throws Exception {
		http
				...
				.and()
				.authorizeRequests()
				.antMatchers(HttpMethod.GET, "/api/**").access("#oauth2.hasScope('user_read')")
				.antMatchers(HttpMethod.POST, "/api/**").access("#oauth2.hasScope('user_write')");
	}
